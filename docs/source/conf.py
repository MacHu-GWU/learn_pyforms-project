# -*- coding: utf-8 -*-
#
# learn_pyforms documentation build configuration file, created by
...
version = learn_pyforms.__version__
# The full version, including alpha/beta/rc tags.
release = learn_pyforms.__version__
...
html_logo = "./_static/learn_pyforms-logo.png"
html_favicon = "./_static/learn_pyforms-favicon.ico"
...
htmlhelp_basename = 'learn_pyformsdoc'
...
latex_documents = [
    (master_doc, 'learn_pyforms.tex', 'learn_pyforms Documentation',
     u'Sanhe Hu', 'manual'),
]
...
man_pages = [
    (master_doc, 'learn_pyforms', 'learn_pyforms Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'learn_pyforms', 'learn_pyforms Documentation',
     author, 'learn_pyforms', 'One line description of project.',
     'Miscellaneous'),
]
...
# Add data for Jinja2
try:
    from learn_pyforms.docs import doc_data
except:
    doc_data = dict()
...
package_name = learn_pyforms.__name__
